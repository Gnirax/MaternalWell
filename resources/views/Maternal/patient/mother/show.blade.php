                ...
                <div class="col-md-8">
                    <form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                <input class="form-control" value="{{ $mothers->firstname }} {{ $mothers->middlename }} {{ $mothers->surname }}" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-5">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        <input class="form-control" value="{{ $mothers->phone_number }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control" value="{{ $mothers->emergency_contact_name }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control" value="{{ $mothers->relationship_with_patient }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-5">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <input class="form-control" value="{{ $mothers->emergency_contact_number }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-5">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input class="form-control" value="{{ $mothers->estimated_due_date }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input class="form-control" value="{{ $mothers->last_menstrual_period }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" style="width: 55px;" value="{{ $mothers->number_of_previous_pregnancies }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" style="width: 55px;" value="{{ $mothers->number_of_previous_live_births }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control" style="width: 55px;" value="{{ $mothers->number_of_previous_miscarriages }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input class="form-control mt-2" type="text" name="allergies"
                                        placeholder="Allergies" value="{{ $mothers->allergies }}" readonly>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row">
                                <input class="form-control mt-2" type="text"
                                    ...
                                    value="{{ $mothers->family_history_of_medical_conditions }}" readonly>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <input class="form-control mt-2 mb-2" type="text" name="member_number"
                                        placeholder="Member number" value="{{ $mothers->member_number }}" readonly>
                                </div>
                                <div class="col-4">
                                    <input class="form-control mt-2 mb-2" type="text" name="group_number"
                                        placeholder="Group number" value="{{ $mothers->group_number }}" readonly>
                                </div>
                                <div class="col-4">
