...
@section('content')
    <div id="mother_index" class="container card shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form method="POST" action="{{ route('mothers.update', $mothers->id) }}">
            ...
            <div class="row">
                <label class="form-label mt-2">Contacts:</label>
                <div class="col-6">
            ...
            <div class="row">
                <label class="form-label mt-2">Emergency Contact Information:</label>
                <div class="col-4">
            ...
            <div class="row">
                <div class="col-6">
                    <label class="form-label mt-2">Estimated due date:</label>
                    <input class="form-control" type="date" name="estimated_due_date"
                        value="{{ $mothers->estimated_due_date }}">
                </div>
                <div class="col-6">
                    <label class="form-label mt-2">Last Menstrual period:</label>
