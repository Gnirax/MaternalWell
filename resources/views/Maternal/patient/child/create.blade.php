    ...
    <div id="child_index" class="container card shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <form method="POST" action="{{ route('childs.store') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-4">
                            <label class="form-label">Mother:</label>
                                <select name="mothers_id" class="form-control form-select form-select-sm">
                                    ...
                                    <option value="{{ $mother->id }}">{{ $mother->firstname }} {{ $mother->surname }}
                                    </option>
                                    @endforeach
                                </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" name="region" placeholder="Dar es salaam,Arusha,...">
                        </div>
                        <div class="col-6">
            ...
            <div class="tab">
                <div class="row">
                    <div class="col-12">
                        <label class="form-label"><h5>Emergency Contact Information:</h5></label>
                    </div>
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="tab">
                <div class="row">
                    <div class="col-11">
                        <label class="form-label"><h5>Medical history:</h5></label>
                    </div>
                    <div class="row">
                        <div class="col-6">
            ...
            <div class="tab">
                <div class="row">
                    <div class="col-11">
                        <label class="form-label"><h5>Insurance Information:</h5></label>
                    </div>
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <input class="form-control mt-2" type="text" name="group_number"
