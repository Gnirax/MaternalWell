...
@section('content')
    ...
    <form id="regForm" class="container shadow-lg bg-body-tertiary rounded"
        action="{{ route('childs.store', $mothers->id) }}" method="POST">
        @csrf
        <h3 style="text-align: center;">CHILD-PATIENT REGISTRATION FORM</h3>
        @if ($errors->any())
            ...
            <div class="row">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" type="text" name="fathers_nationality" placeholder="e.g Tanzanian">
                    </div>
                </div>
                <div class="row mb-1">
                    <div class="col-6">
                        <label class="form-label">Region:</label>
                        <input class="form-control" type="text" name="fathers_region" placeholder="e.g Dar es Salaam">
                    </div>
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input class="form-control" type="text" name="fathers_email" placeholder="someone@something.com">
                    </div>
                    <div class="col-6">
