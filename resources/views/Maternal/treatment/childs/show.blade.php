            ...
            <div class="tab-content">
                <div id="observations" class="tab-pane fade">
                    <div class="form-group">
                        <input type="hidden" name="consultations_id" value="{{ $treatments->consultations_id }}" readonly>
                        <input type="hidden" name="type" value="childs">
                        <input type="hidden" name="childs_id" value="{{ $treatments->childs_id }}" readonly>
                        <label class="form-label">OBSERVATIONS:</label>
                        <textarea name="observations" class="form-control" value="{{ $treatments->observations }}" readonly></textarea>
                    </div>
                </div>
