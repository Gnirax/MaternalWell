...
@section('content')
    <div class="container shadow-lg p-3 mb-5 bg-body-tertiary rounded">
        <h2 style="text-align: center">CHILDREN TREATMENT TABLE</h2>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @forelse($pasttreatments as $pasttreatment)
                            <tr>
                                @if ($pasttreatment->childs_id)
                                    <td>{{ $pasttreatment->childs_id }}</td>
                        ...
                        @forelse($todaytreatments as $todaytreatment)
                            <tr>
                                @if ($todaytreatment->childs_id != null)
                                    <td>{{ $todaytreatment->childs_id }}</td>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @forelse($finishedtreatments as $finishedtreatment)
                            <tr>
                                @if ($finishedtreatment->childs_id)
                                    <td>{{ $finishedtreatment->childs_id }}</td>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @forelse($ongoingtreatments as $ongoingtreatment)
                            <tr>
                                @if ($ongoingtreatment->childs_id != null)
                                    <td>{{ $ongoingtreatment->childs_id }}</td>
